...
/*
Notice This Controller is Designed for tuning ScalingFactor


*/

/*fuzzy controller*/  //For Scaling Factor
float flc(float e,float de)
{
	...
	/*rule table of myself*/  // The Rule Table is design for Tunig 
	int rule[9][3]={{1,1,2},{1,2,1},{1,3,2},
	                {2,1,3},{2,2,2},{2,3,3},
				    {3,1,2},{3,2,1},{3,3,2}};
