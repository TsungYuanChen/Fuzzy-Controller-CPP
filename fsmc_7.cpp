...
/*fuzzy controller*/
float fsmc_7(float e,float de,float E)
{
	int n,condition,set;
	...
	/*menbership function*/
	float
	m1[5][3]={{-1*E,-1*E,-0.5f*E},{-1*E,-0.5f*E,0*E},{-0.5f*E,0*E,0.5f*E},{0*E,0.5f*E,1*E},{0.5f*E,1*E,1*E}},/* e */
	m2[5][3]={{-1*E,-1*E,-0.5f*E},{-1*E,-0.5f*E,0*E},{-0.5f*E,0*E,0.5f*E},{0*E,0.5f*E,1*E},{0.5f*E,1*E,1*E}},/* de */
